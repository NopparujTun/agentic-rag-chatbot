...
vi.mock('../../components/MessageItem', () => ({
  default: ({ message, isLatestAssistantMessage, isThinking }: any) => (
    <div data-testid="message-item" data-role={message.role} data-latest={isLatestAssistantMessage} data-thinking={isThinking}>
      {message.content}
    </div>
  )
}));
...
describe('MainContent', () => {
  it('renders empty state', () => {
    render(<MainContent messages={[]} isSending={false} status="ready" onSendMessage={() => {}} onUploadDocuments={() => {}} />);
  ...
  it('renders messages and hides hero section', () => {
    ...
    render(<MainContent messages={msgs} isSending={false} status="ready" onSendMessage={() => {}} onUploadDocuments={() => {}} />);
  ...
  it('shows thinking indicator message when sending', () => {
    ...
    render(<MainContent messages={msgs} isSending={true} status="ready" onSendMessage={() => {}} onUploadDocuments={() => {}} />);
